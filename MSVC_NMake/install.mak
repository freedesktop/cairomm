...
install: all
	...
	@copy /b vs$(PDBVER)\$(CFG)\$(PLAT)\$(CAIROMM_LIBNAME).dll $(PREFIX)\bin
	@copy /b vs$(PDBVER)\$(CFG)\$(PLAT)\$(CAIROMM_LIBNAME).pdb $(PREFIX)\bin
	@copy /b vs$(PDBVER)\$(CFG)\$(PLAT)\$(CAIROMM_LIBNAME).lib $(PREFIX)\lib
